...
return(
  ...
  <Routes>
    ...
    <Route path="/edit-project/:id" element={<EditProject handleClick={handleClick} click={click} />}></Route>
    <Route path="/edit-member/:id" element={<EditMember handleClick={handleClick} click={click} />}></Route>
